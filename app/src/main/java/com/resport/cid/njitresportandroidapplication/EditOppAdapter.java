...
public class EditOppAdapter extends ArrayAdapter<EditOpp> {

    public EditOppAdapter(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public EditOppAdapter(Context context, int resource, List<EditOpp> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.layout_edit_opp_list, null);
        }

        EditOpp p = getItem(position);
